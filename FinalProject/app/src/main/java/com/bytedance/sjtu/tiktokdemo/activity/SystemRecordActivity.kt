...
import com.bytedance.sjtu.tiktokdemo.utils.PathUtils
import java.io.File
...
class SystemRecordActivity : AppCompatActivity() {
    ...
    fun record(view: View) {
        Log.i("iii","in function record")
        requestPermission()
    }

    private fun requestPermission() {
        Log.i("iii","in function requestPermission")
    ...
    private fun recordVideo() {
        Log.i("iii","in function recordVideo")
